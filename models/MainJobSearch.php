...
/**
 * MainJobSearch represents the model behind the search form about `backend\modules\mainjob\models\MainJob`.
 */
class MainJobSearch extends MainJob
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            [['stc_id'], 'integer'],
            [['stc_name', 'stc_name_eng', 'stc_detail'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'stc_name', $this->stc_name])
            ->andFilterWhere(['like', 'stc_name_eng', $this->stc_name_eng])
            ->andFilterWhere(['like', 'stc_detail', $this->stc_detail]);
